...
from trackers.strong_sort.strong_sort import StrongSORT, StrongSORT_w_Matching
...
def create_tracker(tracker_type, appearance_descriptor_weights, device, half):
    if tracker_type == 'strongsort':
        ...
        # In our setting, AV car image is used as query image
        strongsort = StrongSORT_w_Matching(
            ...
            mc_lambda=cfg.STRONGSORT.MC_LAMBDA,
            ema_alpha=cfg.STRONGSORT.EMA_ALPHA,
            query_img_path=cfg.STRONGSORT.QUERY_PATH
        )
        return strongsort
